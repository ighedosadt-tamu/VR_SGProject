...
public class Portal : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        // Render camera
        var newRotation = portalCamera.transform.rotation;
        var newPosition = portalCamera.transform.position;
        newRotation.y += 90;
        portalCamera.transform.SetPositionAndRotation(newPosition, newRotation);
